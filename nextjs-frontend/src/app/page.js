      ...
      <div className="hero-gradient rounded-3xl p-8 sm:p-12 mb-12 noise-overlay">
        <div className="max-w-3xl">
          ...
          <p className="text-base md:text-lg font-medium text-muted-foreground mb-6">
            Subscribe to fresh produce and never worry about running out. Daily or weekly deliveries
            based on your needs.
          </p>
          <button
              ...
              return (
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full ${stockStatus.class}`}
                      data-testid={`stock-badge-${product.sku}`}
                    >
                      {stockStatus.label}
                    </span>
                  </div>
