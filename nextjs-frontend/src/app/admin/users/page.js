...
export default function AdminUsersPage() {
  ...
  const getRoleBadgeClass = (role) => {
    if (role === 'admin') return 'bg-primary/15 text-primary border border-primary/25';
                  ...
                  {usersData.items.map((user) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium ${getRoleBadgeClass(user.role)}`}
                        >
                          {user.role}
                        </span>
                      </td>
