        ...
        <div>
          <div className="mb-4">
            <div className="flex items-start justify-between mb-2">
              <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight" data-testid="product-name">
                {product.name}
              </h1>
              <span className={`text-xs px-3 py-1 rounded-full ${stockStatus.class}`} data-testid="stock-status">
                {stockStatus.label}
              </span>
            </div>
          ...
          <div className="mb-6">
            <div className="flex items-baseline gap-2 mb-2">
              <span className="text-4xl font-semibold" data-testid="product-price">₹{product.price}</span>
          ...
          <div className="mb-6">
            ...
            <p className="text-base leading-relaxed text-foreground" data-testid="product-description">
